module.exports = {
  ...
  'background': require('@mdi/svg/svg/format-color-fill.svg'),
  'block': require('@mdi/svg/svg/format-pilcrow.svg'),
  'blockquote': require('@mdi/svg/svg/format-quote-close.svg'),
  'bold': require('@mdi/svg/svg/format-bold.svg'),
  'clean': require('@mdi/svg/svg/format-clear.svg'),
  'code': require('@mdi/svg/svg/code-braces.svg'),
  'code-block': require('@mdi/svg/svg/code-braces.svg'),
  'color': require('@mdi/svg/svg/palette.svg'),
  'direction': {
    '': require('@mdi/svg/svg/format-textdirection-l-to-r.svg'),
    'rtl': require('@mdi/svg/svg/format-textdirection-r-to-l.svg')
  },
  'emoji': require('@mdi/svg/svg/emoticon-happy.svg'),
  'float': {
    'center': require('@mdi/svg/svg/format-float-center.svg'),
    'full': require('@mdi/svg/svg/view-day.svg'),
  ...
  'link': require('@mdi/svg/svg/link-variant.svg'),
  'list': {
    'ordered': require('@mdi/svg/svg/format-list-numbers.svg'),
    'bullet': require('@mdi/svg/svg/format-list-bulleted.svg'),
    'check': require('@mdi/svg/svg/format-list-checks.svg')
  },
  'menu': require('@mdi/svg/svg/menu-down.svg'),
  'script': {
    'sub': require('@mdi/svg/svg/format-subscript.svg'),
    'super': require('@mdi/svg/svg/format-superscript.svg')
  },
  'send': require('@mdi/svg/svg/send.svg'),
  'strike': require('@mdi/svg/svg/format-strikethrough.svg'),
  'underline': require('@mdi/svg/svg/format-underline.svg'),
  'video': require('@mdi/svg/svg/movie.svg')
};
