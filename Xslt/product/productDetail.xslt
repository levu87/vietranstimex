...
<xsl:output method="html" indent="yes"/>
  ...
  <xsl:template match="/">
    <div class="projects-detail main-section">
				<div class="container"> 
					<div class="detail">
						...
						<div class="detail__info">
							<h2 class="title"><xsl:value-of disable-output-escaping="yes" select="ProductDetail/Title"></xsl:value-of></h2>
			...
			<div class="other-product main-section">
				<div class="container"> 
					<h2 class="main-title-dark">Sản phẩm khác</h2>
