      ...
      <div id="main_content">
        <div id="clinic-finder" class="relative">
          <div class="system-wrap">
            <div class="chinhanh-system clearfix">
                <h2 class="main-title-dark">
                  <xsl:value-of select="/DealerList/ModuleTitle"></xsl:value-of>
                </h2>
              <div class="container">
                <section class="chinhanh-wrap dealer clearfix">
                  <div class="findmap-wrap dealer__wrapper clearfix">
                    <div class="findmap result-wrapper clearfix">
                      <div class="filtermap">
                    ...
                    <div id="results" class="dealer-list">
                      <!--<div id="ajax_msg" class="result locate mrb15">
                      </div>-->
                      <ul class="addresslist clearfix noli list_system mrb15" style="display: block;" id="list">
                      </ul>
                    </div>
                  </div>
                </section>
